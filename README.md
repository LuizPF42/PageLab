...
<table>
  <tr>
    <td><img src="prints/site.png" alt="Site gerado pelo PageLattes, visto no computador: foto, apresentação, interesses, formação e destaques"></td>
    <td><img src="prints/site-celular.png" width="280" alt="O mesmo currículo no celular, com outra cor e outra fonte"></td>
  </tr>
</table>
...
![Etapa Lattes: instruções para salvar a página do currículo e a área para arrastar o arquivo](prints/lattes.png)
...
![Etapa Conteúdo: nome, foto, texto de apresentação e interesses, já preenchidos a partir do Lattes](prints/conteudo.png)
...
![Etapa Revisão: barra de ajustes em cima e o site pronto embaixo](prints/revisao.png)
...
![Etapa Publicar: o passo a passo para colocar o site no GitHub](prints/publicar.png)
