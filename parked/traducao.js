 ...
 *
 * ESTACIONADO em 2026-09-12 (ver README.md desta pasta). As regras de nome de instituição que moravam
 * aqui voltaram ao construtor em js/ingles.js; este arquivo as recebe de lá (Ingles) e não é carregado.
 */
(function (raiz, fabrica) {
  const I18n = raiz.I18n || (typeof require === 'function' ? require('./i18n.js') : null);
  const Ingles = raiz.Ingles || (typeof require === 'function' ? require('../js/ingles.js') : null);
  const api = fabrica(I18n, Ingles);
  if (typeof module === 'object' && module.exports) module.exports = api;
  else raiz.Traducao = api;
})(typeof self !== 'undefined' ? self : this, function (I18n, Ingles) {
  'use strict';
...
self.onmessage = async e => {
  ...
  // Voltaram ao construtor em 2026-09-14, em js/ingles.js (o site em inglês voltou sem tradução
  // automática, só com regras e campos preenchidos à mão). Este arquivo passa a usá-las de lá.
  const instituicaoEmIngles = Ingles.instituicaoEmIngles;
  const areaEmInglesInteira = Ingles.areaEmInglesInteira;
